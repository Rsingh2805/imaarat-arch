...
<div
    class="h-full bg-center bg-cover p-4 text-white"
    style="background-image: url('{landing}');"
>
    ...
    <div class="fixed bottom-[6rem] text-center">
        <span
            class="glass text-sm text-white rounded-xl px-6 py-1 uppercase serif"
            >Panipat, Haryana</span
        >
    </div>
</div>
